...
export const resetAuthSlice = authSlice.actions.resetAuthSlice;
...
export const register = (data) => async (dispatch) => {
    ...
    try {
        const res = await axios.post(`${BASE_URL}/api/v1/auth/register`, data, { withCredentials: true });
...
export const getUser = () => async (dispatch) => {
    ...
    try {
        const res = await axios.get(`${BASE_URL}/api/v1/auth/me`, { withCredentials: true });
...
export const resetPassword = ({ token, password, confirmPassword }) => async (dispatch) => {
    ...
    try {
        const res = await axios.put(
            `${BASE_URL}/api/v1/auth/password/reset/${token}`,
...
export const updatePassword = (data) => async (dispatch) => {
    ...
    try {
        const res = await axios.put(
            `${BASE_URL}/api/v1/auth/password/update`,
            data ,
            { withCredentials: true, headers: { "Content-Type": "application/json" } }
        );
