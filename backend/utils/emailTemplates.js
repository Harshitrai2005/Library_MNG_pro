export function generateVerificationOtpEmailTemplate(otpCode){
    return ` <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #ccc;">
      <h2 style="color: #fff; text-align: center; background-color: #333; padding: 10px 0;">Verify Your Email Address</h2>
      ...
      <div style="text-align: center; margin: 20px 0;">
        <span style="display: inline-block; font-size: 24px; font-weight: bold; color: #000; padding: 10px 20px; border: 1px solid #000;">
          ${otpCode}
        </span>
      </div>
      <p style="font-size: 16px; color: #ccc;">
...
export function generateForgotPasswordEmailTemplate(resetPasswordUrl){
  ...
  <div style="text-align: center; margin: 20px 0;">
    <a href="${resetPasswordUrl}"
       style="display: inline-block; font-size: 16px; font-weight: bold; color: #000; text-decoration: none; background: #00f; padding: 10px 20px; border-radius: 4px;">
      Reset Password
    </a>
  </div>
